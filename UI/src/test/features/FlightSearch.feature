...
#    Then the user should see the list of available "one-way" flights
    Examples:
      ...
      | Pune     | Mumbai           | 15-03-2026    | 1      | 0        | 0       | Regular  | Economy     |
  ...
  Scenario Outline: User searches round-trip flight successfully
    ...
    Examples:
      | fromCity  | destination_city | departureDate | returnDate | adults | children | infants | fareType |
      | Bengaluru | Delhi            | 10-04-2026    | 15-04-2026 | 2      | 0        | 1       | Regular  |
  ...
  Scenario Outline: User searches multi-city flight successfully
    ...
    And the user enters first city pair "<fromCity1>" to "<toCity1>" with date "<date1>"
    And the user enters second city pair "<fromCity2>" to "<toCity2>" with date "<date2>"
    And the user selects "<adults>" adults, "<children>" children and "<infants>" infants
    And the user selects fare type "<fareType>"
    And the user clicks on Search Flights
    ...
    Examples:
      | fromCity1 | toCity1 | date1      | fromCity2 | toCity2 | date2      | adults | children | infants | fareType |
      | Delhi     | Mumbai  | 01-06-2026 | Mumbai    | Kochi   | 05-06-2026 | 2      | 1        | 0       | Regular  |
